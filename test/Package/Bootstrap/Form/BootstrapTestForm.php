...
use Nemundo\Package\Bootstrap\FormElement\BootstrapRangeBox;

class BootstrapTestForm extends \Nemundo\Package\Bootstrap\Form\BootstrapForm
{

    /**
     * @var \Nemundo\Package\Bootstrap\FormElement\BootstrapNumberBox
     */
    private $number;

    /**
     * @var BootstrapRangeBox
     */
    private $range;
    ...
    public function getContent()
    {
        ...
        $this->number = new BootstrapNumberBox($this);
        $this->number->label = 'Number';
        $this->number->value = 10;
        $this->number->minValue = 10;
        $this->number->maxValue = 100;


        $this->range = new BootstrapRangeBox($this);
        $this->range->label = 'Range';
        $this->range->value = 10;
        $this->range->minValue = 10;
        $this->range->maxValue = 100;
    ...
    protected function onSubmit()
    {
        ...
        (new \Nemundo\Core\Debug\Debug())->write('Number: ' . $this->number->getValue());
        (new \Nemundo\Core\Debug\Debug())->write('Range: ' . $this->range->getValue());
