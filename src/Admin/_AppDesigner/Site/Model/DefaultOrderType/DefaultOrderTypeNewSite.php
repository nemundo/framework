...
use Nemundo\Admin\AppDesigner\Form\Model\DefaultOrderTypeForm;
use Nemundo\Admin\AppDesigner\Parameter\ModelParameter;
use Nemundo\Dev\App\Factory\DefaultTemplateFactory;
use Nemundo\Package\Bootstrap\Layout\BootstrapTwoColumnLayout;
use Nemundo\Web\Site\AbstractSite;

class DefaultOrderTypeNewSite extends AbstractSite
{

    protected function loadSite()
    {
        $this->title = 'New Default Order Type';
        $this->url = 'default-order-type-new';
    ...
    public function loadContent()
    {
        ...
        $breadcrumb->addActiveItem('New Default Order Type');

        $layout = new BootstrapTwoColumnLayout($page);

        $form = new DefaultOrderTypeForm($layout->col1);
