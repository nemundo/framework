...
class AppPrefixAutoNumberTypeExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = AppPrefixAutoNumberTypeModel::class;
$this->externalTableName = "app_model_prefix_auto_number";
...
$this->prefix = new \Nemundo\Model\Type\Text\TextType();
$this->prefix->fieldName = "prefix";
$this->prefix->tableName = $this->parentFieldName . "_" . $this->externalTableName;
$this->prefix->aliasFieldName = $this->prefix->tableName . "_" . $this->prefix->fieldName;
$this->prefix->label = "";
$this->addType($this->prefix);
