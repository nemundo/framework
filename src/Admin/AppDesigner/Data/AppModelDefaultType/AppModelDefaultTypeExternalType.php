...
class AppModelDefaultTypeExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = AppModelDefaultTypeModel::class;
$this->externalTableName = "app_model_default_type";
