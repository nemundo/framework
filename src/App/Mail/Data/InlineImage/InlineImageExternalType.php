...
class InlineImageExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = InlineImageModel::class;
$this->externalTableName = "mail_inline_image";
...
$this->cid = new \Nemundo\Model\Type\Text\TextType();
$this->cid->fieldName = "cid";
$this->cid->tableName = $this->parentFieldName . "_" . $this->externalTableName;
$this->cid->externalTableName = $this->externalTableName;
$this->cid->aliasFieldName = $this->cid->tableName . "_" . $this->cid->fieldName;
$this->cid->label = "Cid";
$this->addType($this->cid);
