...
$this->schedulerId = new \Nemundo\Model\Type\External\Id\NumberExternalIdType($this);
...
$this->schedulerStatusId = new \Nemundo\Model\Type\External\Id\NumberExternalIdType($this);
