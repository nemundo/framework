...
$this->sendMail = new \Nemundo\Model\Type\Number\YesNoType();
$this->sendMail->fieldName = "send_mail";
$this->sendMail->tableName = $this->parentFieldName . "_" . $this->externalTableName;
$this->sendMail->externalTableName = $this->externalTableName;
$this->sendMail->aliasFieldName = $this->sendMail->tableName . "_" . $this->sendMail->fieldName;
$this->sendMail->label = "Send Mail";
$this->addType($this->sendMail);
