...
$this->logTypeId = new \Nemundo\Model\Type\External\Id\UniqueIdExternalIdType($this);
...
$this->sendMail = new \Nemundo\Model\Type\Number\YesNoType($this);
$this->sendMail->tableName = "systemlog_log";
$this->sendMail->externalTableName = "systemlog_log";
$this->sendMail->fieldName = "send_mail";
$this->sendMail->aliasFieldName = "systemlog_log_send_mail";
$this->sendMail->label = "Send Mail";
$this->sendMail->allowNullValue = false;
...
$index = new \Nemundo\Model\Definition\Index\ModelIndex($this);
$index->indexName = "send_mail";
$index->addType($this->sendMail);
